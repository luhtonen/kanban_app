...
describe('Note', () => {
  it('renders children', () => {
    const test = 'test';
    const NoteContent = wrapInTestContext(Note); const component = renderIntoDocument(
  ...
  function wrapInTestContext(DecoratedComponent) {
    ...
    class TextContextContainer extends React.Component {
      render() {
        return <DecoratedComponent {...this.props} />;
      }
    }
    return TextContextContainer;
  }
});
